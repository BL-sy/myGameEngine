...
namespace Hazel {
	...
	void Renderer2D::DrawQuad(const glm::vec2& position, const glm::vec2& size, const glm::vec4& color, float rotation, Ref<Texture2D> texture)
	{
		DrawQuad({ position.x, position.y, 0.0f }, size, color, { 0.5f, 0.5f }, rotation, texture);
	}
	...
	void Renderer2D::DrawQuad(const glm::vec2& position, const glm::vec2& size, const glm::vec4& color, const glm::vec2& anchor, float rotation, Ref<Texture2D> texture)
	{
		DrawQuad({ position.x, position.y, 0.0f }, size, color, anchor, rotation, texture);
	}
	...
	void Renderer2D::DrawQuad(const glm::vec3& position, const glm::vec2& size, const glm::vec4& color, const glm::vec2& anchor, float rotation, Ref<Texture2D> texture)
	{
